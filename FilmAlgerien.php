...
<div class="p">
 ...
 <a class="navbar-brand" href="#">
  ...
  <div class="collapse navbar-collapse" id="navbarSupportedContent">
    ...
    <form class="form-inline my-2 my-lg-0" method="post" action="recherch.php">
    ...
    <div class="body">
       ...
       $u="kabyletv";
        ...
        $sql="SELECT * FROM kabylemovie where category='A'";
        $req= $id->prepare($sql);
        $e=$req->execute(); 
        if(!$e)	{
        ...
        while ( $enreg= $req->fetch() ) {
            ...
            $img=$enreg['image'];
                ...
                echo '<div class="film" onclick="window.location.href =`film.php?id='. $elid .'`"><div class="img"><img src="'. $img .'" alt="walou"></div><div class="name">'.$namev.'</div></div>';
                    ...
                    echo '<div class="film f1" onclick="window.location.href =`film.php?id='. $elid .'`"><div class="img"><img src="'. $img .'" alt="walou"></div><div class="name">'.$namev.'</div></div>';
                }
                $k=$k+1;
        }         
